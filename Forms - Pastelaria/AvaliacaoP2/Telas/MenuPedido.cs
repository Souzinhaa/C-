...
namespace AvaliacaoP2 {
    public partial class MenuPedido : Form {
        ...
        public MenuPedido(Logica logica) {
            InitializeComponent();
            this.logica = logica;
            iniciarComponentes();
        }
        public void iniciarComponentes() {
            numCoxinha.Value = logica.retornarValor("Coxinha");
            numFrango.Value = logica.retornarValor("Frango");
            numBacalhau.Value = logica.retornarValor("Bacalhau");
            numKibe.Value = logica.retornarValor("Kibe");
            numPastel.Value = logica.retornarValor("Pastel");
            numCamarao.Value = logica.retornarValor("Camarão");
            numCroquete.Value = logica.retornarValor("Croquete");
            numTrufa.Value = logica.retornarValor("Trufa");
        }
        ...
        {
            adicionarItem("Camarão", Decimal.ToInt32(numCamarao.Value), 3);
        }
